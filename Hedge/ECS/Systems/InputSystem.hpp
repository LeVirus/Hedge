...
inline const std::map<ControlKey_e, MouseKeyboardInputState> MAP_KEYBOARD_DEFAULT_KEY =
    ...
    {ControlKey_e::AIM_DIAG_DOWN, {true, GLFW_KEY_W}},
    {ControlKey_e::MOVE_LEFT, {true, GLFW_KEY_LEFT}},
    {ControlKey_e::MOVE_RIGHT, {true, GLFW_KEY_RIGHT}},
...
inline const std::map<ControlKey_e, GamepadInputState> MAP_GAMEPAD_DEFAULT_KEY =
    {
    {ControlKey_e::LOOK_UP, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_RIGHT_THUMB, {}}},
    {ControlKey_e::LOOK_DOWN, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_DPAD_RIGHT, {}}},
    {ControlKey_e::AIM_DIAG_UP, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_LEFT_BUMPER, {}}},
    {ControlKey_e::AIM_DIAG_DOWN, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER, {}}},
    {ControlKey_e::MOVE_LEFT, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_DPAD_DOWN, {}}},
    {ControlKey_e::MOVE_RIGHT, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_DPAD_UP, {}}},
    {ControlKey_e::JUMP, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_A, {}}},
    {ControlKey_e::ACTION, GamepadInputState{false, GLFW_GAMEPAD_AXIS_RIGHT_TRIGGER, true}},
    {ControlKey_e::SHOOT, GamepadInputState{true, GLFW_GAMEPAD_BUTTON_X, {}}},
    {ControlKey_e::GRENADE, GamepadInputState{false, GLFW_GAMEPAD_AXIS_LEFT_TRIGGER, true}},
...
class InputSystem : public ECS::System<Components_e::TOTAL_COMPONENTS>
{
public:
    InputSystem();
...
private:
    ...
    const std::map<InputMenuCursorPos_e, ControlKey_e> m_mapInputControl = {
        ...
        {InputMenuCursorPos_e::LOOK_DOWN, ControlKey_e::LOOK_DOWN},
        {InputMenuCursorPos_e::LOOK_UP, ControlKey_e::LOOK_UP},
        ...
        {InputMenuCursorPos_e::MOVE_RIGHT, ControlKey_e::MOVE_RIGHT}
    };
