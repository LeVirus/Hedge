...
void StaticDisplaySystem::updateMenuCursorPosition(PlayerConfComponent &playerComp)
{
    ...
    WriteComponent *writeMenuComp = Ecsm_t::instance().getComponent<WriteComponent, Components_e::WRITE_COMPONENT>(playerComp.m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::MENU_ENTRIES)]);
    ...
    WriteComponent *writeMenuSelectedComp = Ecsm_t::instance().getComponent<WriteComponent, Components_e::WRITE_COMPONENT>(
...
{
    GeneralCollisionComponent *tagColl = Ecsm_t::instance().getComponent<GeneralCollisionComponent, Components_e::GENERAL_COLLISION_COMPONENT>(
    ...
    if(tagColl->m_active)
    {
        ...
        PositionVertexComponent *posComp = Ecsm_t::instance().getComponent<PositionVertexComponent, Components_e::POSITION_VERTEX_COMPONENT>(playerComp.m_vectEntities[static_cast<uint32_t>(
...
void StaticDisplaySystem::displayMenu()
{
    ...
    for(std::set<uint32_t>::iterator it = m_usedEntities.begin(); it != m_usedEntities.end(); ++it)
    {
        ...
        SpriteTextureComponent *spriteBackgroundComp = Ecsm_t::instance().getComponent<SpriteTextureComponent, Components_e::SPRITE_TEXTURE_COMPONENT>(backgroundEntity);
        uint32_t backgroundTitleEntity = playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::MENU_TITLE_BACKGROUND)];
        SpriteTextureComponent *spriteBackgroundTitleComp = Ecsm_t::instance().getComponent<SpriteTextureComponent, Components_e::SPRITE_TEXTURE_COMPONENT>(backgroundTitleEntity);
        uint32_t backgroundLeftEntity = playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::MENU_LEFT_BACKGROUND)];
        SpriteTextureComponent *spriteBackgroundLeftComp = Ecsm_t::instance().getComponent<SpriteTextureComponent, Components_e::SPRITE_TEXTURE_COMPONENT>(backgroundLeftEntity);
        ...
        SpriteTextureComponent *spriteBackgroundRightLeftComp = Ecsm_t::instance().getComponent<SpriteTextureComponent, Components_e::SPRITE_TEXTURE_COMPONENT>(backgroundRightLeftEntity);
...
{
    PositionVertexComponent *posComp = Ecsm_t::instance().getComponent<PositionVertexComponent, Components_e::POSITION_VERTEX_COMPONENT>(backgroundEntity);
...
{
    WriteComponent *writeConf = Ecsm_t::instance().getComponent<WriteComponent, Components_e::WRITE_COMPONENT>(m_resolutionDisplayMenuEntity);
    if(writeConf->m_vectMessage.empty())
    {
        writeConf->m_vectMessage.resize(1);
        writeConf->m_vectMessage[0].first = writeConf->m_upLeftPositionGL.first;
    }
    writeConf->m_vectMessage[0].second = str;
    PositionVertexComponent *posComp = Ecsm_t::instance().getComponent<PositionVertexComponent, Components_e::POSITION_VERTEX_COMPONENT>(m_resolutionDisplayMenuEntity);
    writeConf->m_fontSpriteData[0] = m_fontDataPtr->getWriteData(str, *writeConf, Font_e::STANDARD);
    confWriteVertex(*writeConf, *posComp, VertexID_e::RESOLUTION_DISPLAY_MENU);
}

//===================================================================
void StaticDisplaySystem::updateMenuEntryFullscreen(bool displayMenufullscreenMode)
{
    WriteComponent *writeComp = Ecsm_t::instance().getComponent<WriteComponent, Components_e::WRITE_COMPONENT>(m_fullscreenMenuEntity);
    ...
    PositionVertexComponent *posComp = Ecsm_t::instance().getComponent<PositionVertexComponent, Components_e::POSITION_VERTEX_COMPONENT>(m_fullscreenMenuEntity);
                                                   ...
                                                   InputType_e inputType, bool axisSense)
{
    ...
    WriteComponent *writeComp = Ecsm_t::instance().getComponent<WriteComponent, Components_e::WRITE_COMPONENT>(entityWrite);
...
{
    PositionVertexComponent *pos = Ecsm_t::instance().getComponent<PositionVertexComponent, Components_e::POSITION_VERTEX_COMPONENT>(weaponEntity);
    SpriteTextureComponent *spriteText = Ecsm_t::instance().getComponent<SpriteTextureComponent, Components_e::SPRITE_TEXTURE_COMPONENT>(weaponEntity);
