 ...
 */
class StaticDisplaySystem : public ECS::System<Components_e::TOTAL_COMPONENTS>
{
public:
    StaticDisplaySystem();
...
private:
    ...
    void drawWriteVertex(uint32_t numEntity, VertexID_e type, Font_e font = Font_e::STANDARD, const std::string &value = "", std::optional<double> leftPosition = std::nullopt);
