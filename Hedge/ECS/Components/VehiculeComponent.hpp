...
struct VehicleComponent : public ECS::Component
{
    ...
    bool m_vehicleMemPlayerAssociated = false, m_onStair = false, m_collDownActive = false, m_onLateralGround = true, m_touchGround = false, m_vehicleShoot = false, m_currentShootAnimation = false;
