...
struct PlayerConfComponent : public ECS::Component
{
    ...
    std::optional<uint32_t> m_secretsFound, m_enemiesKilled, m_associatedVehicle = {};
    ...
    bool m_currentDirectionRight = true, m_jumpDown = false, m_dialogPass = false, m_grenadeThrow = false;
