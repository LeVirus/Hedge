...
struct PlayerConfComponent : public ECS::Component
{
    ...
    std::array<uint32_t, 4> m_vectPossessedWeaponsPreviewEntities;
    std::optional<uint32_t> m_associatedVehicle = {};
    ...
    bool m_currentDirectionRight = true, m_jumpDown = false, m_dialogPass = false, m_grenadeThrow = false, m_jumpPush = false;
