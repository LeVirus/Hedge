...
struct EnemyData
{
    ...
    std::vector<uint16_t> m_staticLeftSprites, m_staticRightSprites, m_attackLeftSprites, m_attackRightSprites, m_dyingSprites, m_dyingRightSprites, m_touched, m_touchedRight;
