...
enum Components_e
{
    ...
    WALL_MULTI_SPRITE_CONF_COMPONENT,
    GENERATOR_COMPONENT,
    VEHICLE_COMPONENT,
    TOTAL_COMPONENTS
};
...
enum class PlayerSpriteElementType_e
{
    ...
    JUMP_SHOOT_UP_LOOK_RIGHT,
    JUMP_SHOOT_UP_RIGHT,
    JUMP_SHOOT_RIGHT,
    JUMP_SHOOT_DOWN_RIGHT, //25
    JUMP_SHOOT_DOWN_LOOK_RIGHT,

    JUMP_SHOOT_UP_LOOK_LEFT,
    JUMP_SHOOT_UP_LEFT,
    JUMP_SHOOT_LEFT,
    JUMP_SHOOT_DOWN_LEFT, //30
    ...
    JUMP_AIM_UP_RIGHT,
    JUMP_AIM_DOWN_RIGHT,
    JUMP_AIM_DOWN_LOOK_RIGHT, //45

    JUMP_AIM_UP_LOOK_LEFT,
    JUMP_AIM_UP_LEFT,
    JUMP_AIM_DOWN_LEFT,
    JUMP_AIM_DOWN_LOOK_LEFT, // 49
    TOTAL
...
enum class VehicleSpriteType_e
{
    ...
    SHOOT_MOVE_RIGHT,
    SHOOT_MOVE_LEFT,
    SHOOT_STAIR_UP_RIGHT,
    SHOOT_STAIR_DOWN_RIGHT,
    SHOOT_STAIR_UP_LEFT,
    SHOOT_STAIR_DOWN_LEFT
};
...
inline const std::map<MenuMode_e, PairPairFloatStr_t> MAP_MENU_DATA =
{
    ...
    {MenuMode_e::LEVEL_EPILOGUE,
     PairPairFloatStr_t{{-0.5f, 0.5f}, ""}},
    {MenuMode_e::SOUND,
     PairPairFloatStr_t{{-0.7f, 0.2f}, "Volume Musique\\Volume Effets Sonores\\Retour"}},
    {MenuMode_e::DISPLAY,
     PairPairFloatStr_t{{-0.7f, 0.2f}, "Resolution\\Plein Ecran\\Retour\\Valider"}},
    {MenuMode_e::INPUT,
     PairPairFloatStr_t{{-0.8f, 0.4f}, "Viser Haut\\Viser Bas\\Viser Diagonale Haut\\"
         "Viser Diagonale Bas\\Gauche\\Droite\\Sauter\\Action\\Tirer\\Grenade\\Arme Precedente\\Arme Suivante\\Par Defaut\\Retour\\Valider"}
    },
    {MenuMode_e::NEW_GAME,
     PairPairFloatStr_t{{-0.6f, 0.2f}, "Vide\\Vide\\Vide\\Retour"}
    },
...
//    {GLFW_GAMEPAD_BUTTON_BACK, "Back"},
    ...
    {GLFW_GAMEPAD_BUTTON_DPAD_RIGHT, "Right Thumb"},
    {GLFW_GAMEPAD_BUTTON_RIGHT_THUMB, "Dpad Up"},
    {GLFW_GAMEPAD_BUTTON_DPAD_UP, "Dpad Right"},
    {GLFW_GAMEPAD_BUTTON_DPAD_LEFT, "Dpad Down"},
